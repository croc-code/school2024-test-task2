...
Метод называется getPopularCategories(String jsonFilePath, String startDate, String endDate), на вход требуется 3 аргумента: путь к .json файлу, содержащему информацию о совершённых покупках (находится в папке resources);
